# UI Spec — `ui/icons/narya-logo-transparent-1080.png`
...
| Field | Value |
|---|---|
| Source PNG | `ui/icons/narya-logo-transparent-1080.png` |
| Canvas | 1080×1080px |
| Aspect ratio | 1.0 |
| Alpha / transparency | true |
| Kind | brand/icon asset |
| Route / state | `asset` |
| Human title | narya-logo-transparent-1080.png |
...
| 8 | `#1ebefc` | 2.11% | 0.629 |
| 9 | `#2663fb` | 2.1% | 0.38 |
| 10 | `#7ed2fb` | 1.49% | 0.765 |
| 11 | `#edeffa` | 1.38% | 0.939 |
| 12 | `#138dfc` | 1.37% | 0.483 |
| 13 | `#6765fa` | 1.37% | 0.44 |
| 14 | `#fcfffd` | 0.86% | 0.997 |
| 15 | `#688cfb` | 0.33% | 0.55 |
| 16 | `#fffffd` | 0.28% | 0.999 |
